...
class RapidRoll extends JFrame implements Runnable, KeyListener {
    ...
    RapidRoll() {
        ...
        ic1 = getImageIcon("images/1.gif");
        ic2 = getImageIcon("images/2.gif");
        ic3 = getImageIcon("images/3.gif");
        iclife = getImageIcon("images/life.gif");
        icgameover = getImageIcon("images/gameover.gif");
        icready = getImageIcon("images/ready.gif");
